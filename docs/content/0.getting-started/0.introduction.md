...
- [Inline Minification](/docs/seo-utils/guides/minification): Automatically minify inline scripts (Rolldown/esbuild) and styles (lightningcss) at build time, with optional runtime minification for dynamic SSR
