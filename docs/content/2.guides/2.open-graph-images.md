...
relatedPages:
  - path: /docs/seo-utils/guides/app-icons
    title: App Icons
  - path: /docs/seo-utils/api/share-links
    title: useShareLinks()
...
New to Open Graph tags? Learn more about them with the [Mastering Open Graph Tags](/learn-seo/nuxt/mastering-meta/open-graph) guide.
...
Using Nuxt SEO Utils, you can set up your social share images seamlessly using [Next.js Metadata Files](https://nextjs.org/docs/app/api-reference/file-conventions/metadata/opengraph-image), generating automatic `meta` tags.
...
Twitter images are used to display an image when your site is shared on Twitter.
...
You can provide alternate text for your images by creating a matching `.txt` file for your image.

For example, if you have an image `og-image.png`, you can create an `og-image.alt.txt` file with the alternate text.
