...
relatedPages:
  - path: /docs/seo-utils/guides/canonical-url
    title: Canonical URL
  - path: /docs/seo-utils/guides/i18n
...
on your [site config](/docs/nuxt-seo/guides/site-config).
...
[trailing slashes](/learn-seo/nuxt/routes-and-rendering/trailing-slashes) and non-trailing slashes showing the same content
...
**`canonicalQueryWhitelist`**: by default, it includes a number of common query parameters that will modify the page content:
...
::note
See the [I18n Guide](/docs/seo-utils/guides/i18n) for detailed information on configuring locales, especially if you're experiencing issues with the `lang` attribute.
::
