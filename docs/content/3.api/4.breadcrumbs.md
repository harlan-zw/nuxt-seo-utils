...
relatedPages:
  ...
  - path: /docs/schema-org/getting-started/introduction
...
- Type: `MaybeRefOrGetter<string>`{lang="ts"}
- Default: `useRoute().path`{lang="ts"}
...
- Type: `MaybeRefOrGetter<(BreadcrumbItemProps | false | undefined)[]>`{lang="ts"}
- Default: `[]`{lang="ts"}
...
- Type: `MaybeRefOrGetter<BreadcrumbItemProps[]>`{lang="ts"}
- Default: `[]`{lang="ts"}
