...
- [App Icons / Logos](/docs/utils/guides/app-icons)
- [Open Graph / Twitter Images](/docs/utils/guides/open-graph-images)
...
See the [installation](/docs/utils/getting-started/installation) page for more details.
