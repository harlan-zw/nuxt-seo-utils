...
export interface ModuleOptions {
   ...
   * Lower numbers appear earlier in the `<head>`. Style blocks default to 40-60,
   * so a value below 40 ensures SEO tags appear before them, which is important
   * for OG crawlers that only parse the first 1MB of a page.
   *
   * @default 30
   */
  tagPriority: number
